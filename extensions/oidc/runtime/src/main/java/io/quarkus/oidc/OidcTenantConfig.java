...
public class OidcTenantConfig extends OidcCommonConfig {
    ...
    /**
     * Optional. A unique tenant identifier. It can be set by {@code TenantConfigResolver} providers, which
    ...
    /**
     * Optional. The application type, which can be one of the following {@link ApplicationType} values.
     */
    @ConfigItem(defaultValueDocumentation = "service")
    public Optional<ApplicationType> applicationType = Optional.empty();

    /**
     * Optional. The relative path or absolute URL of the OpenID Connect (OIDC) authorization endpoint, which authenticates users.
    ...
    /**
     * Optional. The relative path or absolute URL of the OIDC UserInfo endpoint.
     * You must set this property for `web-app` applications if OIDC discovery is disabled
    ...
    /**
     * Optional. Relative path or absolute URL of the OIDC RFC7662 introspection endpoint which can introspect both opaque and JSON Web Token (JWT) tokens.
    ...
    /**
     * Optional. Relative path or absolute URL of the OIDC JSON Web Key Set (JWKS) endpoint which returns a JSON Web Key Verification Set.
    ...
    /**
     * Optional. Relative path or absolute URL of the OIDC end_session_endpoint.
    ...
    /**
     * Optional. The public key for the local JWT token verification.
    ...
    public static class CertificateChain {
        /**
         * Optional. Truststore file which keeps thumbprints of the trusted certificates.
         */
        @ConfigItem
        ...
        /**
         * Optional. A parameter to specify the alias of the truststore certificate.
         */
        @ConfigItem
        public Optional<String> trustStoreCertAlias = Optional.empty();

        /**
         * Optional. An optional parameter to specify type of the truststore file. If not given, the type is automatically detected
    ...
    public static class Logout {
        ...
        /**
         * Optional. The relative path of the logout endpoint at the application. If provided, the application is able to initiate the
        ...
        /**
         * Optional. Relative path of the application endpoint where the user should be redirected to after logging out from the OpenID
         * Connect Provider.
    ...
    public static class Backchannel {
        /**
         * Optional. The relative path of the Back-Channel Logout endpoint at the application.
         */
        @ConfigItem
        public Optional<String> path = Optional.empty();
        ...
        /**
         * Optional. Token cache timer interval.
    ...
    public static class Frontchannel {
        /**
         * Optional. The relative path of the Front-Channel Logout endpoint at the application.
         */
        @ConfigItem
        public Optional<String> path = Optional.empty();
    ...
    public static class TokenStateManager {
        ...
        /**
         * Optional. The secret used by the Default TokenStateManager to encrypt the session cookie
    ...
    public static class Roles {
        ...
        /**
         * Optional. A list of paths to claims containing an array of groups.
        ...
        /**
         * Optional. The separator for splitting strings that contain multiple group values.
        ...
        /**
         * Optional. Source of the principal roles.
         */
        @ConfigItem
    ...
    public static class Authentication {
        ...
        /**
         * Optional. Authorization code flow response mode.
         */
        @ConfigItem(defaultValueDocumentation = "query")
        public Optional<ResponseMode> responseMode = Optional.empty();

        /**
         * Optional. The relative path for calculating a `redirect_uri` query parameter.
        ...
        /**
         * Optional. Relative path to the public endpoint which processes the error response from the OIDC authorization endpoint.
        ...
        /**
         * Optional. Force `https` as the `redirect_uri` parameter scheme when running behind an SSL/TLS terminating reverse proxy.
        ...
        /**
         * Optional. Add the `openid` scope automatically to the list of scopes. This is required for OpenId Connect providers,
        ...
        /**
         * Optional. Request URL query parameters which, if present, are added to the authentication redirect URI.
         */
        @ConfigItem
        ...
        /**
         * Optional. Cookie path header parameter value which, if set, identifies the incoming HTTP header
        ...
        /**
         * Optional. Cookie domain parameter value which, if set, is used for the session, state and post logout cookies.
         */
        @ConfigItem
        ...
        /**
         * Optional. If this property is set to `true`, an OIDC UserInfo endpoint is called.
         ...
         * it automatically following the redirect might not work given that OIDC authorization endpoints typically do not support
         * CORS.
         * <p/>
        ...
        /**
         * Optional. Requires that ID token is available when the authorization code flow completes.
        ...
        /**
         * Optional. Internal ID token lifespan.
         * This property is only checked when an internal IdToken is generated when Oauth2 providers do not return IdToken.
         */
        ...
        /**
         * Optional. Requires that a Proof Key for Code Exchange (PKCE) is used.
         */
        @ConfigItem(defaultValueDocumentation = "false")
        public Optional<Boolean> pkceRequired = Optional.empty();

        /**
         * Optional. Secret used to encrypt a Proof Key for Code Exchange (PKCE) code verifier in the code flow state.
        ...
        /**
         * Optional. Secret used to encrypt Proof Key for Code Exchange (PKCE) code verifier and/or nonce in the code flow
         * state.
         * This secret should be at least 32 characters long.
         * <p/>
         * If this secret is not set, the client secret configured with
    ...
    public static class Token {
        ...
        /**
         * Optional. The expected issuer `iss` claim value.
        ...
        /**
         * Optional. The expected audience `aud` claim value, which can be a string or an array of strings.
         *
        ...
        /**
         * Optional. Name of the claim which contains a principal name. By default, the `upn`, `preferred_username` and `sub` claims are
         * checked.
         */
        @ConfigItem
        ...
        /**
         * Optional. The refresh token time skew, in seconds.
        ...
        /**
         * Optional. Custom HTTP header that contains a bearer token.
        ...
        /**
         * Optional. Required signature algorithm.
        ...
        /**
         * Optional. Decryption key location.
         ...
         *
         * This property is set to `true` by default for backward-compatibility reasons. It is planned that this default value will be changed to `false` in an upcoming release.
         *
        ...
        /**
         * Optional. Token customizer name.
         *
        ...
        /**
         * Optional. Indirectly verify that the opaque (binary) access token is valid by using it to request UserInfo.
    ...
    /**
     * Optional. Well known OpenId Connect provider identifier
     */
    @ConfigItem
