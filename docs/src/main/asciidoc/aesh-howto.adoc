...
TIP: With two commands, console mode is auto-detected. See xref:aesh-reference.adoc#mode-auto-detection-rules[Mode auto-detection rules] for the full set of rules.
...
See xref:aesh-concept.adoc#cdi-and-command-scope[CDI and command scope] for the rationale.
...
For the full list of SSH configuration properties, see the xref:aesh-reference.adoc#ssh-configuration-properties[SSH configuration properties reference].
...
For the full `AeshSessionEvent` API, see the xref:aesh-reference.adoc#aeshsessionevent-api[AeshSessionEvent API reference].
